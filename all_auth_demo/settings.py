"""
Django settings for all_auth_demo project.
...
SECRET_KEY = 'zki$ov6r16p$atuhjte1w#+v+$jz+o-3s9f#$!aqdyxgk7zm$%'
...
ROOT_URLCONF = 'all_auth_demo.urls'
...
WSGI_APPLICATION = 'all_auth_demo.wsgi.application'
...
#Account adapters
ACCOUNT_ADAPTER = 'all_auth_demo.adapter.CustomProcessAdapter'

#Account Signup
ACCOUNT_FORMS = {'signup': 'all_auth_demo.forms.SignupForm',}
